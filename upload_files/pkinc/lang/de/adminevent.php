...
'event_access_forbidden'					=> 'Zugriff untersagt',
'eventmessage_access_forbidden'				=> 'Der Zugriff auf die angew&#228;hlte Funktion ist Ihnen untersagt. Sie besitzen nicht die erforderlichen Rechte zum ausf&#252;hren dieser Aktion.',
'event_licence_required'					=> 'G&uuml;ltiger Lizenzschl&uuml;ssel erforderlich',
'eventmessage_licence_required'				=> 'Die Funktion zur Bannereinblendung muss mit einem g&uuml;ltigen Lizenzschl&uuml;ssel aktiviert werden. Sie haben die M&ouml;glichkeit, <a href="'.pkLink('config','licencekey').'">Ihren Lizenzschl&uuml;ssel hier einzutragen</a>. Sollten Sie noch keinen Lizenzschl&uuml;ssel f&uuml;r diese <strong>PHPKIT</strong> Installation besitzen, k&ouml;nnen Sie diesen <a target="_blank" href="http://www.phpkit.com/de/bestellung">hier</a> bestellen.',
'event_page_not_found'						=> 'Seite nicht gefunden',
'eventmessage_page_not_found'				=> 'Die von Ihnen angew&#228;hlte Seite konnte nicht gefunden werden.',
'event_not_a_valid_image'					=> 'Keine g&uuml;ltige Bilddatei',
'eventmessage_not_a_valid_image'			=> 'Die angew&auml;hlte Datei ist keine g&uuml;ltige Bilddatei.',
