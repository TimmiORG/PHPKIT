...
// presets
$member_letterlinks = $searchstr = $row = $member_overview_rows = $order1 = $order2 = $order3 = $error_msg = '';
$counter = array('', '');
$a = array('', '');
...
$searchresult = $SQL->fetch_array($getuserinfo);
...
{
	pkLoadLang('user');
	$error_msg = pkGetLang( 'user_search_error' );
}
